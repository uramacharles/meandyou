<?php
	...
	$post_array = $getter->getMorePosts($post_id);
	//$tems = array("id","title","titlelink","category","post_land_image","date_updated")
	$count = count($post_array);
 if(empty($post_array)): ?>
 	<h3 style="color: green; padding-bottom: 2em; font-weight: bold;">Only One Post is Added Yet. Please Add More.</h3>
 <?php else:?>
        ...
        <div class="container default-portfolio-item col-md-3 col-sm-12 col-xs-12 ">
            <div class="inner-box" style="color:green;font-weight: bold;border-radius:5%;">
                ...
                <figure class="image-box">
                	<img src="<?php echo  $getter->formatUrlforAdmin($post_array[$i+4]); ?>" alt="">
                </figure>
                ...
                <div class="col-md-12">
                	<a href="post/<?php echo $post_array[$i+2]; ?>" style="color: blue; font-weight: bold;font-size:15px;" ><?php echo $post_array[$i+1]; ?></a>
                	<hr style="border-width: 0.2em; border-color:red"  />
                	<span><i><?php echo $post_array[$i+5]; ?></i></span>
                </div>
				<div class="col-md-12">
