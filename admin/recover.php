...
<?php //include_once('adminnav.php'); ?>
  ...
  <div class="container" id="hide" >
    ...
    <div class="container animated fadeInRight" >
      <h3 class="text-center" style="position: relative; z-index: 10; top : 20%; padding-bottom: 1em;padding-top: 2em;">  <a href="adminboard.php"> Me And You </a> > <a href="index.php">Login</a> > Password Recovery</h3>
